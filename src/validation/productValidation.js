...
export const createProductSchema = Joi.object({
                        ...
                        .items(
                            Joi.object({
                                ...
                                value: Joi.string().required().messages({
                                    ...
                                    "string.empty":
                                        "Giá trị thuộc tính biến thể không được để trống",
    ...
    seoTitle: Joi.string().allow("").max(60).messages({
        "string.base": "SEO Title phải là chuỗi",
        "string.max": "SEO Title không được vượt quá {#limit} ký tự",
    }),
    seoDescription: Joi.string().allow("").max(160).messages({
        "string.base": "SEO Description phải là chuỗi",
        "string.max": "SEO Description không được vượt quá {#limit} ký tự",
    }),
